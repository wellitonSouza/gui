            ...
            <div className="lst-entry-title col s12">
                ...
                <div className="col s5 options">
                    {this.props.is_showing ? (
                        <div className="searchBtn operations" onClick={this.toggleDevice} title="Hide Device">
                            <i className="fa fa-eye" />
                        </div>
                    ) : (
                        <div className="searchBtn operations" onClick={this.toggleDevice} title="Show Device">
