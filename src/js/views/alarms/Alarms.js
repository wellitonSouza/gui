...
class AlarmsPage extends Component {
    ...
    filterResults() {
        ...
        let result = this.props.currentAlarms.filter(f => severityList.includes(f.severity.toLowerCase()));
            ...
            <div id={'alarm-main-area'} className={'total-area'}>
                ...
                <div id={'alarm-content-area'} className={'content-area'}>
                    <div id={'alarm-list-header'} className={'alarm-header'}>
                        <div>Showing&nbsp; <span>{this.state.filteredList.length}</span> &nbsp;Alarms</div>
                    </div>
                    <div id={'alarm-list-area'} className={'list-area'}>
                        <ReactCSSTransitionGroup
                            ...
                            {this.state.filteredList.map((list) =>
                                <AlarmRow {...list} key={list._id}/>
                            )}
                        </ReactCSSTransitionGroup>
                    </div>
                </div>
...
function AlarmTabs() {
    return (
        <div id={'tabs-area'} className={'alarms-tabs-area'}>
            <div id={'tab-current'} className={'tab-area selected'}>
                <div id={'history-tab'} className={'text-area'}>Current</div>
            </div>
            {/*<div id={'tab-history'} className={'tab-area'}>*/}
                {/*<div id={'current-tab'} className={'text-area'}>History</div>*/}
            {/*</div>*/}
...
function SideMenu(props) {
    ...
    return (
        <div id={'menu-area'} className={'side-menu'}>
            ...
            <div id={'warning-row'} className={'menu-row warning ' + (props.active.warning ? 'row-selected' : '')}
            ...
            <div id={'minor-row'} className={'menu-row minor ' + (props.active.minor ? 'row-selected' : '')}
            ...
            <div id={'major-row'} className={'menu-row major ' + (props.active.major ? 'row-selected' : '')}
            ...
            <div id={'critical-row'} className={'menu-row critical ' + (props.active.critical ? 'row-selected' : '')}
